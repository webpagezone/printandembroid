...
if ( current_user_can( 'edit_theme_options' ) ) {
	$default_title = __( 'Exclusive products', 'shop-isle' );
	if ( ! class_exists( 'WC_Product' ) ) {
		$default_subtitle = __( 'For this section to work, you first need to install the WooCommerce plugin , create some products, and select a product category in Customize -> Frontpage sections -> Products slider section', 'shop-isle' );
	}
}
